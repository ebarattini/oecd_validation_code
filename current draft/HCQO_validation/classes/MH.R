...
InitializeMH1 <- function(df_raw) {
  col.names <- c('Y15T19', 'Y20T24', 'Y25T29', 'Y30T34', 'Y35T39', 'Y40T44','Y45T49', 'Y50T54', 'Y55T59Y', 'Y60T64', 'Y65T69', 'Y70T74', 'Y75T79','Y80T84', 'Y_GE85')
  row.names <- c('M', 'F','T')
...
# Corresponds to these indicators "EXCEBIPO", "EXCESCHI"
