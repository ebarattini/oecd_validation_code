####################################################################################################
## load_csv function
# this function is designed to help load the data depending on how it is structured/which extension it takes
...
load_csv <- function(file_path) {
  ...
  if (!is.null(df_raw)) {
    ...
    required_columns <- c("REF_AREA", "TIME_PERIOD", "MEASURE", "SEX", "UNIT", "OBS_VALUE")
